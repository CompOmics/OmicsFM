...
```bash
python transcriptomics/single_cell/build_sc_dataset.py --config ... --datasets all_transcripts protein_mapped
```
...
output_dir: transcriptomics/single_cell/output
...
```
transcriptomics/single_cell/output/
├── all_transcripts/
...
```
transcriptomics/single_cell/split/
├── all_transcripts/
...
A = ad.read_h5ad("transcriptomics/single_cell/split/all_transcripts/train.h5ad")  # or backed="r"
...
```yaml
data:
  train_path: transcriptomics/single_cell/split/all_transcripts/train.h5ad
  valid_path: transcriptomics/single_cell/split/all_transcripts/valid.h5ad
  test_path:  transcriptomics/single_cell/split/all_transcripts/test.h5ad
  num_bins: 10
